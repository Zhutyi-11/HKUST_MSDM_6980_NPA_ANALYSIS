...
WORKSPACE = r'c:\Users\marcozhu\Desktop\6980'
OUT_DIR = os.path.join(WORKSPACE, 'agent_outputs', 'baseline_comparison_run')
...
full_df = pd.read_excel(os.path.join(WORKSPACE, 'data.xlsx'))
