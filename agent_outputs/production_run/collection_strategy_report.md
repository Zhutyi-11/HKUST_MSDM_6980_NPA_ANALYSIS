...
## 4. Champion-Challenger Summary
| Model | Valid ROC-AUC | Valid Brier | Recall(Y) | Precision(Y) | Expected Net Recovery | Expected ROI | Threshold |
|---|---:|---:|---:|---:|---:|---:|---:|
| xgboost | 0.709 | 0.0832 | 73.73% | 15.92% | 1,555,044 | 31.09x | 0.09 |
| balanced_random_forest | 0.708 | 0.0841 | 73.31% | 15.43% | 1,460,440 | 29.20x | 0.08 |

## 5. Holdout Performance (T set)
...
## 9. Additional Portfolio Signals
